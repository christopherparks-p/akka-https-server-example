...
akka.management.http.routes {
  test4 = "example.HttpManagementEndpointSpecRoutesScaladsl"
}
"""
  )
  ...
  try {
    ...
    val endpoint = s"https://127.0.0.1:$httpPort/scaladsl"
    ...
    val responseGetMembers = Await.result(responseGetMembersFuture, 15.seconds)
